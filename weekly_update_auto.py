"""
Weekly Incremental Update Pipeline - AUTOMATION VERSION
Runs without prompts for GitHub Actions
"""
import sys
import os
...
from scripts.fpl_api_parsers import create_player_name_map, parse_fpl_player_gameweek_stats_with_names, parse_fpl_fixtures
from scripts.load_player_gameweek_stats import load_player_gameweek_stats

print("=" * 70)
print("🔄 WEEKLY INCREMENTAL UPDATE (AUTOMATED)")
print("=" * 70)
